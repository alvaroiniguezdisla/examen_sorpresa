...
public class Gestion {
    ...
    public  ArrayList listar(ArrayList<Cliente> clientes) {
    ...
    public  Cliente consultar(String DNI, ArrayList<Cliente> clientes) {
    ...
    public  void modificarnombreapellido(String DNI,String nombre,String apellido,ArrayList<Cliente> clientes){
    ...
    public  void eliminar(String DNI,ArrayList<Cliente> clientes){
